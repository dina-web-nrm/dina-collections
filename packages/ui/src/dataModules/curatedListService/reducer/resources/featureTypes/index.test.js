...
describe('dataModules/curatedListService/reducer/resources/featureTypes', () => {
  ...
  describe('reducer', () => {
    ...
    it(`merges previous state with new data on ${CURATED_LIST_SERVICE_GET_FEATURE_OBSERVATION_TYPES_SUCCESS}`, () => {
      const state = {
        1: {
          id: '1',
          name: 'Alan',
    ...
    it(`updates existing resource when keeping other resources on ${CURATED_LIST_SERVICE_UPDATE_FEATURE_OBSERVATION_TYPE_SUCCESS}`, () => {
      const state = {
        appl: {
          id: 'appl',
          name: 'Apple Inc.',
