export default () =>
  describe('form content', () => {
    beforeEach(() => {
      cy.visit('/app/specimens/mammals/1/edit/sections/0')
    ...
    it('has record history and help texts', () => {
      ...
      cy.queryByTestId('inlineNotification').should('not.exist')
      ...
      cy.queryByTestId('modalNotification').should('not.exist')
